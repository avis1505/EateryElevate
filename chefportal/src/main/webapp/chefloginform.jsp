 ...
 <div class="breadcam_area breadcam_bg_1 zigzag_bg_2">
    <div class="breadcam_inner">
       <div class="breadcam_text">
          <h3>Chef Sign In</h3>
          <p>"Welcome back, Chef! Your kitchen headquarters awaits. Access your profile, manage bookings, and 
          <br>stay connected with Flavorful Chef Connect."</p>
       </div>
    </div>
 </div>
 <!-- breadcam_area_end -->
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Chef Sign In</h2>
                    </div>
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="chefloginsubmit.jsp" method="post" id="" novalidate="novalidate">
                            <div class="row">
                            ...
                            <div class="form-group mt-3">
                             ...
                             <div class="form-group mt-3">
                                <a href="chefregform.jsp" class="link text-danger">Not yet account? Join Now</a>
                            </div>
                        </form>
                    </div>
