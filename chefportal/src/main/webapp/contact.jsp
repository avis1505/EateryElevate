 ...
 <div class="breadcam_area breadcam_bg_1 zigzag_bg_2">
    <div class="breadcam_inner">
       <div class="breadcam_text">
          <h3>Contact</h3>
          <p>"Got questions? We've got answers! <br> Reach out faster than it takes to order your favorite dessert. Contact us now!"
       </div>
    </div>
 </div>
 <!-- breadcam_area_end -->
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="contactsubmit.jsp" method="post" id="" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
